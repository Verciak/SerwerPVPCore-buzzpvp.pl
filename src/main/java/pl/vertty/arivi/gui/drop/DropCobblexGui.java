...
public class DropCobblexGui {
    ...
    public static void openMain(final Player player) {
        ...
        for(Item item : CobblexCommand.drops){
        ...
        menu.addCategory("MainCobblexGUI", category);
        menu.setName(ChatUtil.fixColor("&9MENU DROPU"));
        menu.setOnlyRead(true);
        menu.show(player);
        InventoryMenuHandler.registerNewMenu("MainCobblexGUI", menu);
    }
