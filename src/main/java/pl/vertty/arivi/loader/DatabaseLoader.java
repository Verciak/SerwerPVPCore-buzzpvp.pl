...
public class DatabaseLoader
{
    ...
    public static void onDatabaseLoad() {
        ...
        if (conn) {
            ...
            DatabaseLoader.store.update(true, "CREATE TABLE IF NOT EXISTS `pCGuilds_users` (`id` int(100) NOT NULL PRIMARY KEY AUTO_INCREMENT, `name` varchar(32) NOT NULL, `points` int(100) NOT NULL, `kills` int(100) NOT NULL, `deaths` int(100) NOT NULL, `asysts` int(100) NOT NULL, `upr_lava` int(1) NOT NULL, `upr_water` int(1) NOT NULL, `upr_break_obsidian` int(1) NOT NULL, `upr_break_stone` int(1) NOT NULL, `upr_place_obsidian` int(1) NOT NULL, `upr_place_stone` int(1) NOT NULL, `upr_chest` int(1) NOT NULL, `upr_tnt` int(1) NOT NULL, `upr_boyfarmer` int(1) NOT NULL, `upr_lapis` int(1) NOT NULL, `upr_logblock` int(1) NOT NULL, `upr_furnace` int(1) NOT NULL, `incognitoNick` int(1) NOT NULL, `incognitoSkin` int(1) NOT NULL, `incognitoGuild` int(1) NOT NULL, `role` varchar(32) NOT NULL, `kamien` int(100) NOT NULL, `kox` int(100) NOT NULL, `refil` int(100) NOT NULL, `enderchest1` LONGTEXT NOT NULL, `enderchest2` LONGTEXT NOT NULL, `enderchest3` LONGTEXT NOT NULL, `enderchest4` LONGTEXT NOT NULL, `enderchest5` LONGTEXT NOT NULL, `odblokowane_kamien` int(100) NOT NULL, `odblokowane_zabojstw` int(100) NOT NULL, `odblokowane_zgonow` int(100) NOT NULL, `odblokowane_kox` int(100) NOT NULL, `odblokowane_refil` int(100) NOT NULL, `firstIP` varchar(100) NOT NULL, `lastIP` varchar(100) NOT NULL, `firstJoin` bigint(22) NOT NULL, `schowek_kox` int NOT NULL, `schowek_refy` int NOT NULL, `schowek_perly` int NOT NULL, `schowek_sniezki` int NOT NULL, `prestiz` int NOT NULL, `kit_start` bigint(64) NOT NULL, `kit_yt` bigint(22) NOT NULL, `kit_vip` bigint(22) NOT NULL, `kit_svip` bigint(22) NOT NULL, `kit_tnt` bigint(22) NOT NULL, `turboDrop` bigint(22) NOT NULL, `turboExp` bigint(22) NOT NULL, `ochrona` bigint(22) NOT NULL,`home1` varchar(255) NOT NULL,`home2` varchar(255) NOT NULL,`home3` varchar(255) NOT NULL,`home4` varchar(255) NOT NULL,`home5` varchar(255) NOT NULL, `lastKill` varchar(32) NOT NULL, `lastKillTime` bigint(22) NOT NULL, `god` int(1) NOT NULL, `lvl` int(100) NOT NULL, `exp` int(100) NOT NULL, `group` varchar(32) NOT NULL, `pandora` int NOT NULL, `klucze` int NOT NULL);");
